...
\begin{tabular}{l l l}
		\textbf{Work}& Arbeitsumfang & Einheit: Anzahl Personentage, Mannstunden\\
		\textbf{Duration} & Zeitdauer & Einheit: Anzahl Stunden,Tage\\
		\textbf{Units}& Intensität& Einheit: Angabe der Beteiligung in Prozent\\
\end{tabular}